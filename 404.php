...
<head>
    ...
    <style type="text/css">
        ...
        @keyframes move-clouds-back {
            from {background-position:-450px 0;}
        ...
        @keyframes move-cloud2-back {
            from {background-position:0 0;}
            to {background-position:10000px 0;}
        }
        @-webkit-keyframes move-cloud2-back {
            from {background-position:0 0;}
            to {background-position:10000px 0;}
        }
        @-moz-keyframes move-cloud2-back {
            from {background-position:0 0;}
            to {background-position:10000px 0;}
        }
        @-ms-keyframes move-cloud2-back {
        ...
        .clouds{
            ...
            z-index:3;
            -moz-animation:move-clouds-back 20s linear infinite;
            -ms-animation:move-clouds-back 20s linear infinite;
            -o-animation:move-clouds-back 20s linear infinite;
            -webkit-animation:move-clouds-back 20s linear infinite;
        ...
        .cloud2{
            ...
            z-index:4;
            -moz-animation:move-clouds-back 30s linear infinite;
            -ms-animation:move-clouds-back 30s linear infinite;
            -o-animation:move-clouds-back 30s linear infinite;
            -webkit-animation:move-clouds-back 30s linear infinite;
            animation:move-clouds-back 30s linear infinite;
        }
...
<body  style="background-color:white;" onload="javascript:fg_hideform('fg_formContainer','fg_backgroundpopup');">
	    ...
	    <div class="navbar-inner ">
            ...
            <div class="container" style="margin-top:-95px;">
                ...
                <div class="nav-collapse collapse pull-right" style="font-family: 'Abel', sans-serif;font-size:15px; ">
                    <ul class="nav" >
                        <li  style="padding:2px; margin-right:200px;font-weight:;"><a href="index.php">Oh No! Page Crashed And Moved to Heaven</a></li>
    ...
    <div class="cloud2" style="margin-bottom:-20%;"></div>
    ...
    <div style="background-color:white;" class="center">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/404.jpg" style="margin-bottom:-22px;margin-top:-40px;margin-right:45px;" class="center"/>
    </div>
        ...
        <div class="container">
            <div class="row-fluid">
                <div class="span5 cp"  style="font-family: 'Josefin Slab', serif;; font-size:15px;">
                    &copy; 2016 <a target="blank" href="https://www.facebook.com/Concettoiitdhanbad/?ref=ts&fref=ts" title="Techfest IIT(ISM) DHANBAD"><b>Concetto</b></a>. All Rights Reserved. <h5>Site designed and maintained by <b>Manish Kumar</b></h5>
                </div>
                <!--/Copyright-->
                ...
                <div class="container-a1  center">
                    <ul class="caption-style-1 ">
                        <li>
                            ...
                            <div class="caption">
                                <a href="https://www.facebook.com/profile.php?viewas=100000686899395&privacy_source=timeline_gear_menu" target="blank">
                                    <div class="blur"></div>
                        ...
                        <li>
                            ...
                            <div class="caption">
                                <a href="https://www.facebook.com/profile.php?id=100004284617032&fref=ts" target="blank">
                                    <div class="blur"></div>
                        ...
                        <li>
                            ...
                            <div class="caption">
                                <a href="https://www.facebook.com/siddharth.mishra.31149?fref=ts" target="blank">
                                    <div class="blur"></div>
                                    <div class="caption-text center" style="margin-left:-10px;">
                                        <h1>Siddharth</h1>
                                    </div>
