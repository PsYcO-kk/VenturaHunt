<?php
    ...
    if ( isset($_POST['btn-signup']) ) {
        ...
        if( !$error ) {
            ...
            $res1 = mysqli_query($dbcon, "update login set password='$password' where hash='$hash' "); 
                    ...
                    <html>
                        <body style="background-color:#f1f1f1;">
                            ...
                            <div style="background-color:#98FB98; margin-left:20%;margin-right:20%; border-radius:4px;">
                                ...
                                <p style="font-family: \'Abel\', sans-serif;font-size:15px; background-color:#98FB98; margin-left:2%;margin-right:2%; padding-left:1.6%;">
                                    Press the button below to go to VenturaHunt.<br/><br/>
                                </p>
                                ...
                                <p style="font-family: \'Abel\', sans-serif;font-size:15px;  background-color:#98FB98; margin-left:2%;margin-right:2%; padding-left:1.6%;">
                                    Or, just open this link to go to VentuaHunt :<br/>
                                </p>
                                <p style="font-family: \'Abel\', sans-serif;font-size:15px;  background-color:#98FB98; margin-left:2%;margin-right:2%; padding-left:1.6%;">
                                ...
                                <p style="font-family: \'Abel\', sans-serif;font-size:15px;  background-color:#98FB98; margin-left:2%;margin-right:2%; padding-left:1.6%;">
                                    Team VenturaHunt - Concetto 2k16<br/>
                                </p>
                            </div>
                            <p style="margin-top:2%;background-color:#F5DEB3; border-radius:2px;padding-left:1.6%; font-family: \'Abel\', sans-serif;font-size:12px;  margin-left:20%;margin-right:20%;">
                                Please contact us if you did not requested for password change. 
                            </p>
                        </body>
                    </html>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top  " >
	    <div class="navbar-inner ">
			<a class="navbar-brand  router-link-active" href="">
                <div class="cd-logo header-footer-sprite"  style="height:90px; width:120px;">	<img src="images/logo.png" class="img-rounded img-responsive" style="margin-top:5px;width:120px;height:90px;"/></div>
            </a>
                ...
                <div class="container-a1  center">
                    <ul class="caption-style-1 ">
                        ...
                        <li>
                            ...
                            <div class="caption">
                                <a href="https://www.facebook.com/ayush.tiwari.11?fref=ts" target="blank">
                                    <div class="blur"></div>
                ...
                <div class="container-a1  center">
                    <ul class="caption-style-1 ">	
                        <li>
                            ...
                            <div class="caption">
                                <a href="https://www.facebook.com/parardha.kumar.7?ref=ts&fref=ts" target="blank">
                                    <div class="blur"></div>
                                    <div class="caption-text " style="margin-left:-10px;">
                                        <h1>Parardha</h1>						
                                    </div>
