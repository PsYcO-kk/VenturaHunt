<?php
	...
	$result2 = mysqli_query($dbcon, "select * from profile where username='$username'");
	$user = mysqli_fetch_assoc($result);
	$userscore = mysqli_fetch_assoc($result2);
?>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top  " >
	    <div class="navbar-inner ">
			<a class="navbar-brand  router-link-active" href="">
				<div class="cd-logo header-footer-sprite" style="height:90px; width:120px;"><img src="images/logo.png" class="img-rounded img-responsive" style="margin-top:5px;width:110px;height:90px;"/></div>
			</a>
